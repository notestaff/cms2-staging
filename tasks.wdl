...
task compute_one_pop_cms2_components {
  ...
  File script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/is-220510-1344-update-miniconda/e625499d4c2a0ab3552aa9246f3ace23230a68a1/compute_cms2_components.py"
  File misc_utils = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/is-220510-1344-update-miniconda/e625499d4c2a0ab3552aa9246f3ace23230a68a1/misc_utils.py"  # !UnusedDeclaration
...
task normalize_and_collate_block {
  ...
  File normalize_and_collate_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/is-220510-1344-update-miniconda/e625499d4c2a0ab3552aa9246f3ace23230a68a1/norm_and_collate_block.py"
  command <<<
    set -ex -o pipefail
...
task collate_stats_and_metadata_for_sel_sims_block {
  ...
  File collate_stats_and_metadata_for_sel_sims_block_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/is-220510-1344-update-miniconda/e625499d4c2a0ab3552aa9246f3ace23230a68a1/collate_stats_and_metadata_for_sel_sims_block.py"
...
# ** outputs
  ...
  File construct_pops_info_for_1KG_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/is-220510-1344-update-miniconda/e625499d4c2a0ab3552aa9246f3ace23230a68a1/construct_pops_info_for_1KG.py"
...
# ** outputs
  ...
  File fetch_empirical_hapsets_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/is-220510-1344-update-miniconda/e625499d4c2a0ab3552aa9246f3ace23230a68a1/fetch_empirical_hapsets.py"
...
# ** outputs
  ...
  File fetch_neutral_regions_nre_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/is-220510-1344-update-miniconda/e625499d4c2a0ab3552aa9246f3ace23230a68a1/fetch_neutral_regions_nre.py"
...
# ** outputs
  ...
  File compute_intervals_stats_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/is-220510-1344-update-miniconda/e625499d4c2a0ab3552aa9246f3ace23230a68a1/compute_intervals_stats.py"
...
# ** outputs
  ...
  File construct_neutral_regions_list_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/is-220510-1344-update-miniconda/e625499d4c2a0ab3552aa9246f3ace23230a68a1/construct_neutral_regions_list.py"
