...
task compute_one_pop_cms2_components {
  ...
  File script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/srong-2022-08-06-01/82efe9777eeac3804b76f794b4b29356a657fec4/compute_cms2_components.py"
  File misc_utils = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/srong-2022-08-06-01/82efe9777eeac3804b76f794b4b29356a657fec4/misc_utils.py"  # !UnusedDeclaration
...
task normalize_and_collate_block {
  ...
  File normalize_and_collate_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/srong-2022-08-06-01/82efe9777eeac3804b76f794b4b29356a657fec4/norm_and_collate_block.py"
  command <<<
    set -ex -o pipefail
...
task collate_stats_and_metadata_for_sel_sims_block {
  ...
  File collate_stats_and_metadata_for_sel_sims_block_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/srong-2022-08-06-01/82efe9777eeac3804b76f794b4b29356a657fec4/collate_stats_and_metadata_for_sel_sims_block.py"
...
# ** outputs
  ...
  input {
    File superpop_to_representative_pop_json = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/srong-2022-08-06-01/82efe9777eeac3804b76f794b4b29356a657fec4/resources/superpop-to-representative-pop.json"
    File empirical_regions_bed
  }
  File construct_pops_info_for_1KG_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/srong-2022-08-06-01/82efe9777eeac3804b76f794b4b29356a657fec4/construct_pops_info_for_1KG.py"
...
# ** outputs
  ...
  File fetch_empirical_hapsets_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/srong-2022-08-06-01/82efe9777eeac3804b76f794b4b29356a657fec4/fetch_empirical_hapsets.py"
...
# ** outputs
  ...
  File fetch_neutral_regions_nre_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/srong-2022-08-06-01/82efe9777eeac3804b76f794b4b29356a657fec4/fetch_neutral_regions_nre.py"
...
# ** outputs
  ...
  File compute_intervals_stats_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/srong-2022-08-06-01/82efe9777eeac3804b76f794b4b29356a657fec4/compute_intervals_stats.py"
...
# ** outputs
  ...
  File construct_neutral_regions_list_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/srong-2022-08-06-01/82efe9777eeac3804b76f794b4b29356a657fec4/construct_neutral_regions_list.py"
