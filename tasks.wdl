...
task compute_one_pop_cms2_components {
  ...
  File script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/is-220211-1632-make-minimal-sim-train-data/d729892f31c169300fae795dd45401f7416ee777/compute_cms2_components.py"
  File misc_utils = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/is-220211-1632-make-minimal-sim-train-data/d729892f31c169300fae795dd45401f7416ee777/misc_utils.py"  # !UnusedDeclaration
...
task normalize_and_collate_block {
  ...
  File normalize_and_collate_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/is-220211-1632-make-minimal-sim-train-data/d729892f31c169300fae795dd45401f7416ee777/norm_and_collate_block.py"
  command <<<
    set -ex -o pipefail
...
task collate_stats_and_metadata_for_sel_sims_block {
  ...
  File collate_stats_and_metadata_for_sel_sims_block_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/is-220211-1632-make-minimal-sim-train-data/d729892f31c169300fae795dd45401f7416ee777/collate_stats_and_metadata_for_sel_sims_block.py"
...
# ** outputs
  ...
  File construct_pops_info_for_1KG_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/is-220211-1632-make-minimal-sim-train-data/d729892f31c169300fae795dd45401f7416ee777/construct_pops_info_for_1KG.py"
...
# ** outputs
  ...
  File fetch_empirical_hapsets_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/is-220211-1632-make-minimal-sim-train-data/d729892f31c169300fae795dd45401f7416ee777/fetch_empirical_hapsets.py"
...
# ** outputs
  ...
  File fetch_neutral_regions_nre_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/is-220211-1632-make-minimal-sim-train-data/d729892f31c169300fae795dd45401f7416ee777/fetch_neutral_regions_nre.py"
...
# ** outputs
  ...
  File compute_intervals_stats_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/is-220211-1632-make-minimal-sim-train-data/d729892f31c169300fae795dd45401f7416ee777/compute_intervals_stats.py"
...
# ** outputs
  ...
  File construct_neutral_regions_list_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/is-220211-1632-make-minimal-sim-train-data/d729892f31c169300fae795dd45401f7416ee777/construct_neutral_regions_list.py"
