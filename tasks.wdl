...
task compute_one_pop_cms2_components {
  ...
  File script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/is-220819-1337-neutralome-with-margins/2315ac4bbd85d5e531f4f77f15f3096fd431df9a/compute_cms2_components.py"
  File misc_utils = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/is-220819-1337-neutralome-with-margins/2315ac4bbd85d5e531f4f77f15f3096fd431df9a/misc_utils.py"  # !UnusedDeclaration
...
task compute_one_pop_bin_stats_for_normalization {
  ...
  Int n_bins_ihh12 = 1
  File trim_margins_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/is-220819-1337-neutralome-with-margins/2315ac4bbd85d5e531f4f77f15f3096fd431df9a/trim_margins.py"
...
task normalize_and_collate_block {
  ...
  File normalize_and_collate_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/is-220819-1337-neutralome-with-margins/2315ac4bbd85d5e531f4f77f15f3096fd431df9a/norm_and_collate_block.py"
  command <<<
    set -ex -o pipefail
...
task collate_stats_and_metadata_for_sel_sims_block {
  ...
  File collate_stats_and_metadata_for_sel_sims_block_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/is-220819-1337-neutralome-with-margins/2315ac4bbd85d5e531f4f77f15f3096fd431df9a/collate_stats_and_metadata_for_sel_sims_block.py"
...
# ** outputs
  ...
  input {
    File superpop_to_representative_pop_json = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/is-220819-1337-neutralome-with-margins/2315ac4bbd85d5e531f4f77f15f3096fd431df9a/resources/superpop-to-representative-pop.json"
    File empirical_regions_bed
  }
  File construct_pops_info_for_1KG_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/is-220819-1337-neutralome-with-margins/2315ac4bbd85d5e531f4f77f15f3096fd431df9a/construct_pops_info_for_1KG.py"
...
# ** outputs
  ...
  File fetch_empirical_hapsets_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/is-220819-1337-neutralome-with-margins/2315ac4bbd85d5e531f4f77f15f3096fd431df9a/fetch_empirical_hapsets.py"
...
# ** outputs
  ...
  File fetch_neutral_regions_nre_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/is-220819-1337-neutralome-with-margins/2315ac4bbd85d5e531f4f77f15f3096fd431df9a/fetch_neutral_regions_nre.py"
...
# ** outputs
  ...
  File compute_intervals_stats_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/is-220819-1337-neutralome-with-margins/2315ac4bbd85d5e531f4f77f15f3096fd431df9a/compute_intervals_stats.py"
...
# ** outputs
  ...
  File get_intervals_chroms_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/is-220819-1337-neutralome-with-margins/2315ac4bbd85d5e531f4f77f15f3096fd431df9a/get_intervals_chroms.py"
...
# ** outputs
  ...
  File construct_neutral_regions_list_script = "gs://fc-21baddbc-5142-4983-a26e-7d85a72c830b/cms2-work/is-220819-1337-neutralome-with-margins/2315ac4bbd85d5e531f4f77f15f3096fd431df9a/construct_neutral_regions_list.py"
